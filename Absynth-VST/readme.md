...
<br>
1. Pick LLM or Local, both work<br>
2. For LLM also set Temperature -> see included comfy workflow for documentation<br>
3. Set Note Density -> sets the amount of notes basicly<br>
4. Prompt create a trance chord riff...(prompt examples see workflow)<br>
5. Yes! It generates Midi that really fits to your chords it has detected :-)<br>
